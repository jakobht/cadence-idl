...
func (m *GetClusterInfoResponse) GetAuthConfig() *AuthConfig {
	if m != nil {
		return m.AuthConfig
	}
	return nil
...
type AuthConfig struct {
	// Known values: "none", "oidc". Unknown values should be treated as "none".
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	// Populated when type == "oidc".
	Oidc                 *OIDCAuthConfig `protobuf:"bytes,2,opt,name=oidc,proto3" json:"oidc,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *AuthConfig) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *AuthConfig) GetOidc() *OIDCAuthConfig {
	if m != nil {
		return m.Oidc
	}
	return nil
...
type OIDCAuthConfig struct {
	// OIDC issuer URL. Clients discover endpoints via
	// <issuer>/.well-known/openid-configuration.
	IssuerUrl string `protobuf:"bytes,1,opt,name=issuer_url,json=issuerUrl,proto3" json:"issuer_url,omitempty"`
	// Public client ID clients use when initiating an OIDC flow. The same client
	// is expected to support whichever flow the client picks (authorization code +
	// PKCE for browsers, device authorization for CLIs). Operators with separate
	// clients per flow should configure their OIDC provider to share audience.
...
func (m *OIDCAuthConfig) Reset()         { *m = OIDCAuthConfig{} }
func (m *OIDCAuthConfig) String() string { return proto.CompactTextString(m) }
func (*OIDCAuthConfig) ProtoMessage()    {}
func (*OIDCAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_674d14d2fee4e473, []int{33}
}
func (m *OIDCAuthConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OIDCAuthConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OIDCAuthConfig.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OIDCAuthConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OIDCAuthConfig.Merge(m, src)
}
func (m *OIDCAuthConfig) XXX_Size() int {
	return m.Size()
}
func (m *OIDCAuthConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_OIDCAuthConfig.DiscardUnknown(m)
}

var xxx_messageInfo_OIDCAuthConfig proto.InternalMessageInfo

func (m *OIDCAuthConfig) GetIssuerUrl() string {
	if m != nil {
		return m.IssuerUrl
	}
	return ""
...
func (m *OIDCAuthConfig) GetClientId() string {
	if m != nil {
		return m.ClientId
	}
	return ""
...
func (*RefreshWorkflowTasksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_674d14d2fee4e473, []int{37}
}
...
func (*RefreshWorkflowTasksResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_674d14d2fee4e473, []int{38}
}
...
func init() {
	...
	proto.RegisterType((*AuthConfig)(nil), "uber.cadence.api.v1.AuthConfig")
	proto.RegisterType((*OIDCAuthConfig)(nil), "uber.cadence.api.v1.OIDCAuthConfig")
...
var fileDescriptor_674d14d2fee4e473 = []byte{
	...
	,
}
...
func (m *AuthConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintServiceWorkflow(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *OIDCAuthConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OIDCAuthConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OIDCAuthConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ClientId) > 0 {
		...
		i = encodeVarintServiceWorkflow(dAtA, i, uint64(len(m.ClientId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.IssuerUrl) > 0 {
		...
		i = encodeVarintServiceWorkflow(dAtA, i, uint64(len(m.IssuerUrl)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *OIDCAuthConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OIDCAuthConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OIDCAuthConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OIDCAuthConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
